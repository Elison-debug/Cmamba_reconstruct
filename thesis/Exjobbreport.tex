...
indoor localization applications. Working with you has been a very valuable experience in
our master's study.
...
Slim-Mamba architecture, and implement the key Mamba datapath on FPGA with
...
\begin{figure}[H]
  ...
  \caption{Comparison of common localization backbones in terms of how temporal context is represented and how data dependencies are introduced during inference.}
...
The deployment configuration used in the later hardware chapters is
...
\begin{figure}[H]
  \centering
  \includesvg[width=0.70\linewidth]{generated_figures/ssm_block_flownew.svg}
