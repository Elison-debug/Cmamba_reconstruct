...
localization. We first adopted a Channel-Mamba-style design\cite{zeng2024cmamba} to support multi-domain 
...
Channel-Mamba prototype and found that a short window (\(K=16\), about 0.16\,s at 100\,Hz)
