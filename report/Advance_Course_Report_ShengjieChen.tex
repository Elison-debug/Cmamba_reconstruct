...
1.44~W, providing a baseline toward end-to-end Mamba inference. To support reproducibility, the accelerator implementation is open-sourced at \url{https://github.com/Elison-debug/Cmamba_reconstruct.git}.
\end{abstract}
