...
HD_PWD='E:/Master/2025/Mamba/Cmamba_reconstruct/prj/xilinx/project_reconstruct.runs/u_xt_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log u_xt_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source u_xt_rom.tcl
