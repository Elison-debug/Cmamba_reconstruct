...
#
# Script generated by Vivado on Sat Dec 20 03:23:01 +0100 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : slim_WBUF_bank_dp.sh
...
#
# Usage        : slim_WBUF_bank_dp.sh
#                slim_WBUF_bank_dp.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                slim_WBUF_bank_dp.sh [-reset_run]
#                slim_WBUF_bank_dp.sh [-reset_log]
#                slim_WBUF_bank_dp.sh [-help]
#
...
# script info
echo -e "slim_WBUF_bank_dp.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./slim_WBUF_bank_dp.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot slim_WBUF_bank_dp xil_defaultlib.slim_WBUF_bank_dp xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim slim_WBUF_bank_dp -key {Behavioral:sim_1:Functional:slim_WBUF_bank_dp} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb slim_WBUF_bank_dp.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./slim_WBUF_bank_dp.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: slim_WBUF_bank_dp.sh [-help]\n\
Usage: slim_WBUF_bank_dp.sh [-step]\n\
Usage: slim_WBUF_bank_dp.sh [-lib_map_path]\n\
Usage: slim_WBUF_bank_dp.sh [-reset_run]\n\
Usage: slim_WBUF_bank_dp.sh [-reset_log]\n\
Usage: slim_WBUF_bank_dp.sh [-keep_index]\n\
Usage: slim_WBUF_bank_dp.sh [-noclean_files]\n\n\
