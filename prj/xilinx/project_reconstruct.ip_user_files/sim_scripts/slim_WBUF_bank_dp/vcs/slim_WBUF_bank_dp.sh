...
#                script (type 'slim_WBUF_bank_dp.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.slim_WBUF_bank_dp xil_defaultlib.glbl -o slim_WBUF_bank_dp_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./slim_WBUF_bank_dp_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key slim_WBUF_bank_dp_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc slim_WBUF_bank_dp_simv.daidir vcs_lib c.obj)
