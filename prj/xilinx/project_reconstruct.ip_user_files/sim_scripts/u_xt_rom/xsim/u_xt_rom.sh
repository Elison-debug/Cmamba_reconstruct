...
#
# Script generated by Vivado on Sun Jan 11 15:47:53 +0100 2026
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : u_xt_rom.sh
...
#
# Usage        : u_xt_rom.sh
#                u_xt_rom.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                u_xt_rom.sh [-reset_run]
#                u_xt_rom.sh [-reset_log]
#                u_xt_rom.sh [-help]
#
...
# script info
echo -e "u_xt_rom.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./u_xt_rom.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot u_xt_rom xil_defaultlib.u_xt_rom xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim u_xt_rom -key {Behavioral:sim_8:Functional:u_xt_rom} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb u_xt_rom.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./u_xt_rom.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: u_xt_rom.sh [-help]\n\
Usage: u_xt_rom.sh [-step]\n\
Usage: u_xt_rom.sh [-lib_map_path]\n\
Usage: u_xt_rom.sh [-reset_run]\n\
Usage: u_xt_rom.sh [-reset_log]\n\
Usage: u_xt_rom.sh [-keep_index]\n\
Usage: u_xt_rom.sh [-noclean_files]\n\n\
