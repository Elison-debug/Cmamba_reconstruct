...
#                script (type 'u_xt_rom.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.u_xt_rom xil_defaultlib.glbl -o u_xt_rom_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./u_xt_rom_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key u_xt_rom_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc u_xt_rom_simv.daidir vcs_lib c.obj)
