...
#
# Script generated by Vivado on Sun Jan 11 15:46:37 +0100 2026
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot s_buffer xil_defaultlib.s_buffer xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim s_buffer -key {Behavioral:sim_8:Functional:s_buffer} -tclbatch cmd.tcl -log simulate.log
}
