...
#                script (type 'bias2sigmoid_fifo.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bias2sigmoid_fifo xil_defaultlib.glbl -o bias2sigmoid_fifo_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bias2sigmoid_fifo_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key bias2sigmoid_fifo_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bias2sigmoid_fifo_simv.daidir vcs_lib c.obj)
