...
#
# Script generated by Vivado on Thu Dec 25 09:49:47 +0100 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bias2sigmoid_fifo.sh
...
#
# Usage        : bias2sigmoid_fifo.sh
#                bias2sigmoid_fifo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bias2sigmoid_fifo.sh [-reset_run]
#                bias2sigmoid_fifo.sh [-reset_log]
#                bias2sigmoid_fifo.sh [-help]
#
...
# script info
echo -e "bias2sigmoid_fifo.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bias2sigmoid_fifo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_10 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bias2sigmoid_fifo xil_defaultlib.bias2sigmoid_fifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bias2sigmoid_fifo -key {Behavioral:sim_2:Functional:bias2sigmoid_fifo} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bias2sigmoid_fifo.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bias2sigmoid_fifo.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bias2sigmoid_fifo.sh [-help]\n\
Usage: bias2sigmoid_fifo.sh [-step]\n\
Usage: bias2sigmoid_fifo.sh [-lib_map_path]\n\
Usage: bias2sigmoid_fifo.sh [-reset_run]\n\
Usage: bias2sigmoid_fifo.sh [-reset_log]\n\
Usage: bias2sigmoid_fifo.sh [-keep_index]\n\
Usage: bias2sigmoid_fifo.sh [-noclean_files]\n\n\
