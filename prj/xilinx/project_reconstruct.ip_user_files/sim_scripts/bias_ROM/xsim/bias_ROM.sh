...
#
# Script generated by Vivado on Wed Dec 24 15:54:34 +0100 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bias_ROM xil_defaultlib.bias_ROM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bias_ROM -key {Behavioral:sim_1:Functional:bias_ROM} -tclbatch cmd.tcl -log simulate.log
}
