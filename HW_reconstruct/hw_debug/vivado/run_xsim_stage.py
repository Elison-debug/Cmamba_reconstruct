...
def _stage_cfg(stage: str) -> dict:
    ...
    ip_wrappers = [
        ...
        str(PROJ_IP_GEN_DIR / "norm_gamma_rom_ip" / "sim" / "norm_gamma_rom_ip.v"),
    ...
    if stage == "reuse_rmsnorm_scheduler_hw_debug":
        return {
            "tb_top": "tb_reuse_rmsnorm_scheduler_hw_debug",
            "tb_file": str(TB_DIR / "tb_reuse_rmsnorm_scheduler_hw_debug.sv"),
            "sources": shared_sources,
            "xsim_plusargs": [],
            "xvlog_defines": [],
        }
