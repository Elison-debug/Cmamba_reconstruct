...
simulate()
{
  xsim inproj_vec_out_sram_ip -key {Behavioral:sim_1:Functional:inproj_vec_out_sram_ip} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_48ac.protoinst" -protoinst "protoinst_files/bd_886d.protoinst" -log simulate.log
}
