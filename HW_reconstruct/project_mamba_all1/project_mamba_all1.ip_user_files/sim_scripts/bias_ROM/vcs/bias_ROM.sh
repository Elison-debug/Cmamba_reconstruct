...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bias_ROM xil_defaultlib.glbl -o bias_ROM_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bias_ROM_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key bias_ROM_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bias_ROM_simv.daidir vcs_lib c.obj)
