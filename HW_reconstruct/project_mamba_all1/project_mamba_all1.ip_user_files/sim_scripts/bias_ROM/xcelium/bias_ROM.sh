...
#
# Script generated by Vivado on Thu Apr 16 01:10:09 +0200 2026
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bias_ROM.sh
...
#
# Usage        : bias_ROM.sh
#                bias_ROM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bias_ROM.sh [-reset_run]
#                bias_ROM.sh [-reset_log]
#                bias_ROM.sh [-help]
#
...
#                script (type 'bias_ROM.sh -help' for more information).
#
...
# script info
echo -e "bias_ROM.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bias_ROM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.bias_ROM xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.bias_ROM -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log bias_ROM_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bias_ROM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bias_ROM.sh [-help]\n\
Usage: bias_ROM.sh [-step]\n\
Usage: bias_ROM.sh [-lib_map_path]\n\
Usage: bias_ROM.sh [-reset_run]\n\
Usage: bias_ROM.sh [-reset_log]\n\
Usage: bias_ROM.sh [-keep_index]\n\
Usage: bias_ROM.sh [-noclean_files]\n\n\
