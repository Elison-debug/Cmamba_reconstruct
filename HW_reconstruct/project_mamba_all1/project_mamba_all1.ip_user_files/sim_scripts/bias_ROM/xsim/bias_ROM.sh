...
simulate()
{
  xsim bias_ROM -key {Behavioral:sim_3:Functional:bias_ROM} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_48ac.protoinst" -protoinst "protoinst_files/bd_886d.protoinst" -log simulate.log
}
