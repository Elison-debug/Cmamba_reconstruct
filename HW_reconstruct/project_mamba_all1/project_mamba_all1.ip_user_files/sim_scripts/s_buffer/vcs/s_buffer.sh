...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.s_buffer xil_defaultlib.glbl -o s_buffer_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./s_buffer_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key s_buffer_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc s_buffer_simv.daidir vcs_lib c.obj)
