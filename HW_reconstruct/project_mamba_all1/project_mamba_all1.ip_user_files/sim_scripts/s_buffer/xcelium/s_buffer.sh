...
#
# Script generated by Vivado on Tue Apr 14 02:31:20 +0200 2026
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : s_buffer.sh
...
#
# Usage        : s_buffer.sh
#                s_buffer.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                s_buffer.sh [-reset_run]
#                s_buffer.sh [-reset_log]
#                s_buffer.sh [-help]
#
...
#                script (type 's_buffer.sh -help' for more information).
#
...
# script info
echo -e "s_buffer.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./s_buffer.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.s_buffer xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.s_buffer -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log s_buffer_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./s_buffer.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: s_buffer.sh [-help]\n\
Usage: s_buffer.sh [-step]\n\
Usage: s_buffer.sh [-lib_map_path]\n\
Usage: s_buffer.sh [-reset_run]\n\
Usage: s_buffer.sh [-reset_log]\n\
Usage: s_buffer.sh [-keep_index]\n\
Usage: s_buffer.sh [-noclean_files]\n\n\
