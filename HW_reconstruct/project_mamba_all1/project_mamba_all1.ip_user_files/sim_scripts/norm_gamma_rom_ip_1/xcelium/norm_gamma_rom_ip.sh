...
#
# Script generated by Vivado on Thu Apr 16 22:21:30 +0200 2026
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : norm_gamma_rom_ip.sh
...
#
# Usage        : norm_gamma_rom_ip.sh
#                norm_gamma_rom_ip.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                norm_gamma_rom_ip.sh [-reset_run]
#                norm_gamma_rom_ip.sh [-reset_log]
#                norm_gamma_rom_ip.sh [-help]
#
...
#                script (type 'norm_gamma_rom_ip.sh -help' for more information).
#
...
# script info
echo -e "norm_gamma_rom_ip.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./norm_gamma_rom_ip.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work blk_mem_gen_v8_4_8 $xmvlog_opts +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.norm_gamma_rom_ip xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.norm_gamma_rom_ip -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log norm_gamma_rom_ip_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./norm_gamma_rom_ip.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: norm_gamma_rom_ip.sh [-help]\n\
Usage: norm_gamma_rom_ip.sh [-step]\n\
Usage: norm_gamma_rom_ip.sh [-lib_map_path]\n\
Usage: norm_gamma_rom_ip.sh [-reset_run]\n\
Usage: norm_gamma_rom_ip.sh [-reset_log]\n\
Usage: norm_gamma_rom_ip.sh [-keep_index]\n\
Usage: norm_gamma_rom_ip.sh [-noclean_files]\n\n\
