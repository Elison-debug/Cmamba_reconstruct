...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work blk_mem_gen_v8_4_8 $vlogan_opts +v2k +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"F:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.norm_gamma_rom_ip xil_defaultlib.glbl -o norm_gamma_rom_ip_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./norm_gamma_rom_ip_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key norm_gamma_rom_ip_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc norm_gamma_rom_ip_simv.daidir vcs_lib c.obj)
