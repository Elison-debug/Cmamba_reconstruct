...
# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_17 -L smartconnect_v1_0 -L xilinx_vip"
...
simulate()
{
  xsim norm_gamma_rom_ip -key {Behavioral:sim_3:Functional:norm_gamma_rom_ip} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_48ac.protoinst" -protoinst "protoinst_files/bd_886d.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
