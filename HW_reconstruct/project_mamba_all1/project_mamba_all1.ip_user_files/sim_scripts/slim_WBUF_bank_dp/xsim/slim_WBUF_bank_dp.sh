...
#
# Script generated by Vivado on Fri Apr 03 02:11:58 +0200 2026
...
simulate()
{
  xsim slim_WBUF_bank_dp -key {Behavioral:sim_5:Functional:slim_WBUF_bank_dp} -tclbatch cmd.tcl -log simulate.log
}
