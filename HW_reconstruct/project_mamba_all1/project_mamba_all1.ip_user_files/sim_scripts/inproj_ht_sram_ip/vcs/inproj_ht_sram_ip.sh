...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.inproj_ht_sram_ip xil_defaultlib.glbl -o inproj_ht_sram_ip_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./inproj_ht_sram_ip_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key inproj_ht_sram_ip_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc inproj_ht_sram_ip_simv.daidir vcs_lib c.obj)
