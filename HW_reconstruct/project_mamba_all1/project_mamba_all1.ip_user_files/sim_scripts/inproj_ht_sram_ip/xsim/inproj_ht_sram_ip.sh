...
#
# Script generated by Vivado on Thu Apr 16 07:37:12 +0200 2026
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot inproj_ht_sram_ip xil_defaultlib.inproj_ht_sram_ip xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim inproj_ht_sram_ip -key {Behavioral:sim_3:Functional:inproj_ht_sram_ip} -tclbatch cmd.tcl -log simulate.log
}
