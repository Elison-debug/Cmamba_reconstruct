...
namespace eval ::optrace {
  variable script "E:/course/master/mamba/Cmamba_reconstruct/HW_reconstruct/project_mamba_all1/project_mamba_all1.runs/synth_1/reuse_mamba_block_top.tcl"
...
synth_design -top reuse_mamba_block_top -part xczu9eg-ffvb1156-2-e
...
write_checkpoint -force -noxdef reuse_mamba_block_top.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file reuse_mamba_block_top_utilization_synth.rpt -pb reuse_mamba_block_top_utilization_synth.pb"  } 
