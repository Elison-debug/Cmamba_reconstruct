...
HD_PWD='E:/course/master/mamba/Cmamba_reconstruct/HW_reconstruct/project_mamba_all1/project_mamba_all1.runs/s_buffer_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log s_buffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source s_buffer.tcl
