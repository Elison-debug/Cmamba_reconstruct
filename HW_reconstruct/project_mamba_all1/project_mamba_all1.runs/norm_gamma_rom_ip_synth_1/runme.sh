...
HD_PWD='D:/Mamba/CMamba_refactor/Cmamba_reconstruct/HW_reconstruct/project_mamba_all1/project_mamba_all1.runs/norm_gamma_rom_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log norm_gamma_rom_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source norm_gamma_rom_ip.tcl
