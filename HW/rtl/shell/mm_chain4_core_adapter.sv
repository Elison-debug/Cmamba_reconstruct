...
// Function:
//   Board-shell/core bridge for slim_mamba_chain4_top.
//   The external shell contract stays identical to the legacy adapter,
//   while the instantiated core entrypoint moves into the mm namespace.
//---------------------------------------------------------------
