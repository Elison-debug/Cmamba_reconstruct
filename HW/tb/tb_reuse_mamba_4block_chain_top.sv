...
module tb_reuse_mamba_4block_chain_top;
  ...
  // Optional deep internal compare for debug-only builds.
  // Keep disabled by default to avoid hierarchy coupling across RTL variants.
`ifdef TB_DEEP_INTERNAL_CHECK
